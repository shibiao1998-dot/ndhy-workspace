...
NDHY AI Agent Team 是一个真实的实验：用一个人类产品经理 + 一群 AI Agent，组建一支能交付产品的团队。所有 Agent 运行在 [OpenClaw](https://github.com/nicobailey/openclaw)（开源 AI Agent 平台）上，通过飞书沟通，在 GitHub 协作。
...
<sub>Powered by [OpenClaw](https://github.com/nicobailey/openclaw) · Built by 黄世彪 & his AI team · 2026</sub>
