---
name: deployment-ops
description: "部署运维执行工具箱：将交付物安全、可控、可观测地部署到目标环境，建立发布、监控、告警、回滚和运行反馈闭环。覆盖9步标准流程，3级深度分级，12大能力方向，含反模式防范、就绪判断框架、回滚决策树、发布检查清单。Use when: 部署、发布、上线、运维、回滚、监控告警、发布检查。Triggers on: 部署, deployment, 发布, release, 上线, 运维, 回滚, rollback, 监控告警, 健康检查, 发布检查, release checklist, 环境校验, 发布风险, 发布观察, 运行反馈."
---
